#> set_lmt:lib/lmt/_touch_16
# @within set_lmt:lib/lmt/touch

execute if data storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2] run data modify storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2] set from storage set_lmt.__temp__:lib/lmt __io__.lmt.cache
...
data modify storage set_lmt.__temp__:lib/lmt __io__.lmt.cache set from storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2]
