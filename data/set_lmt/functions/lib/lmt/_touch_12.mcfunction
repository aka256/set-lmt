#> set_lmt:lib/lmt/_touch_12
# @within set_lmt:lib/lmt/touch

execute if data storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2] run data modify storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2] set from storage set_lmt.__temp__:lib/lmt __io__.lmt.cache

execute store result score $t0 set_lmt.temp run data get storage set_lmt.__temp__:lib/lmt __io__.index
scoreboard players set $t1 set_lmt.temp 1048576
...
data modify storage set_lmt.__temp__:lib/lmt __io__.lmt.cache set from storage set_lmt.__temp__:lib/lmt __io__.lmt._[-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2][-2]
