...
# 実行結果の保存
  data modify storage set_lmt.__temp__:set_3d-vec __io__.is_element set from storage set_lmt.__temp__:lib/lmt_hash __io__.is_element
