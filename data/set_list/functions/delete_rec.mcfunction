...
execute if score $t0 set_list.temp matches 1 run data modify storage set_list.__temp__: __io__.list[-1] set from storage set_list.__temp__: __temp__.cache[-1]
